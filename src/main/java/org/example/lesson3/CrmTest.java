...
public class CrmTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        actions.moveToElement(driver.findElement(By.xpath("//a/span[.='Расходы']"))).build().perform();
        driver.findElement(By.xpath("//span[.='Заявки на расходы']")).click();

        driver.findElement(By.xpath("//a[.='Создать заявку на расход']")).click();

        driver.findElement(By.name("crm_expense_request[description]")).sendKeys("erh4h54rth");
